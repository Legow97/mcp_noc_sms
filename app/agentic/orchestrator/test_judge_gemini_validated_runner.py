...
def main() -> None:
    """
    Runner para probar el juez con Gemini y validar la salida
    contra el contrato interno JudgeDecision.
    """
...
""".strip()
    ...
    validated_result = parse_judge_response(raw_response)

    print("\n=== VALIDATED JUDGE DECISION ===\n")
