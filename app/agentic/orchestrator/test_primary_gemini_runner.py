...
def main() -> None:
    """
    Runner para probar solo el extractor principal con Gemini.

    Este runner valida:
    - lectura de configuración desde .env
    - construcción de prompts
    - invocación real del modelo principal
    - recepción de salida textual

    Todavía no parsea a CanonicalExtractionResult.
    Solo prueba la conexión real del provider.
    """
...
""".strip()
    ...
    prompt_settings = PromptSettings(
        ...
        extra_instruction=(
            "Devuelve una extracción fiel, conservadora y compatible con el "
